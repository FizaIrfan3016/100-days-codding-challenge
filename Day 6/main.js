...
console.log('ques : 16');
var guest = ['Shahid', 'Rumina', 'Muskan'];
...
guest.forEach(function (guests) {
    console.log("".concat(guests, ", You are invited for dinner."));
});
...
while (guest.length > 2) {
    ...
    console.log("Sorry, ".concat(Remove_guest, ", I cant invite you for dinner"));
}
;
guest.forEach(function (guests) {
...
console.log('ques : 18');
var favouritePlace = ['Saudia Arabia', 'South Korea', 'Bali', 'Japan'];
console.log('Original order', favouritePlace);
console.log('Alphabetical order', __spreadArray([], favouritePlace, true).sort());
console.log('Original order', favouritePlace);
console.log('Reverse alphabetical order', __spreadArray([], favouritePlace, true).sort().reverse());
console.log('Original order', favouritePlace);
