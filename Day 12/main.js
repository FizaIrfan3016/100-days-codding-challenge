...
var pizzas = ['Fajitta', 'Italian style', 'BBQ'];
...
var animals = ['Cat', 'Dog', 'Parrot', 'Fish'];
...
function make_shirt(size, message) {
    console.log("Making a ".concat(size, " size t-shirt with the print of this message ").concat(message));
}
make_shirt('medium', 'Codding is my life!');
